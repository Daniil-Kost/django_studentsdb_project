...
def get_style(request):
    if request.COOKIES.get('current_style') == 'default':
        ...
        pk = '#226f75'
        return pk
    # if we don't selected style - blue #d9edf7 will be default
    else:
        pk = '#d9edf7'
        return pk
...
def get_background(request):
    if request.COOKIES.get('current_bg') == 'white':
        ...
        pk = '#d1d88c'
        return pk
    # if we don`t selected background - white #FFFAFA will be default
    else:
        pk = '#FFFAFA'
        return pk
...
def get_color_text(request):
    if request.COOKIES.get('current_tc') == 'white':
        ...
        pk = '#5bc0de'
        return pk
    # if we don`t selected color - black #333 will be default
    else:
        pk = '#333'
        return pk
