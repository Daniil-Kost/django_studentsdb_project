...
from students.views.students import StudentUpdateView, StudentDeleteView, PageUpdateView
from students.views.students import StudentAddView, StudentsList
...
from stud_auth.views import UserRegistrationView
...
urlpatterns = [
    ...
    url(r'^page/(?P<slug>[-\w]+)/$', PageUpdateView.as_view(),
        name='page'),

    # Students urls
    url(r'^$', StudentsList.as_view(),
        name='home'),
